...
{
    /**
     * AUDIO PLL: output frequency = Fref(24Mhz) * (DIV_SELECT + NUM / DENOM)
     * freq = 24MHz * (32 + 153600000/200000000) = 786432000 Hz
     */
     ...
     * sai1, sai2, sai3
     * source: AudioPll
     * freq: source / pre divider + 1 / divider + 1 = 786432000 / 1 / 64 = 12288000 Hz
     */
    ...
    CLOCK_SetDiv(kCLOCK_Sai3Div, 63);
     ...
     */
    IOMUXC_GPR->GPR5 |= IOMUXC_GPR_GPR5_GPT2_CAPIN1_SEL(true);

    /**
     * Select sai1_clk_root as clock for Observability Clock 2 Output
     */
    CCM->CCOSR = CCM_CCOSR_CLKO2_SEL(0x12) | CCM_CCOSR_CLKO2_DIV(0) | CCM_CCOSR_CLKO2_EN(true);
...
{
    const clock_enet_pll_config_t enet_pll_config = {
