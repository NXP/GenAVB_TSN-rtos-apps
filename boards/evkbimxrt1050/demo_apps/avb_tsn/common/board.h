...
#define BOARD_IODEV_UART_BASEADDR        LPUART2
#define BOARD_IODEV_UART_BAUDRATE        (115200U)
#define BOARD_IODEV_UART_CLK_FREQ        BOARD_DebugConsoleSrcFreq()
#define BOARD_IODEV_UART_RING_BUFFER_LEN (256)
#define BOARD_IODEV_UART_INTERRUPT_MASK  (kLPUART_IdleLineInterruptEnable)

/*! @brief ENET Reset and Int pins */
#define BOARD_ENET_RESET_GPIO   GPIO1
#ifdef CONFIG_APP_MCR
#define BOARD_ENET_RESET_PIN    19
#else
#define BOARD_ENET_RESET_PIN    9
#endif
#define BOARD_ENET_INT_GPIO     GPIO1
#define BOARD_ENET_INT_PIN      10
...
/*! @brief AVB/TSN related configuration */
#define BOARD_SAI_MCLK_HZ      12288000U
#define BOARD_IDLE_COUNT_PER_S 22218648.57
