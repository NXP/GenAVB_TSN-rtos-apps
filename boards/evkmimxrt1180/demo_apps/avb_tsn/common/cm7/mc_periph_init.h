...
#define M1_MCDRV_ENC_GET_INDEX_INT_STATUS(par) (MCDRV_QdEncGetIndexInterruptStatus(par))
#define M1_MCDRV_ENC_CLEAR_INDEX_INT_STATUS(par) (MCDRV_QdEncClearIndexInterruptStatus(par))
