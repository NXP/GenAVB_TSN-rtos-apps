...
#define EXAMPLE_FLEXSPI_AMBA_BASE (0x28000000u) /* FlexSPI1_AMBA_BASE, with fix to use non-secure address */
#define EXAMPLE_FLEXSPI_PORT kFLEXSPI_PortA1
#define FLASH_SIZE 0x4000 /* 128Mb/KiB (128*1024*1024 / 1024 / 8) */
#define FLASH_PAGE_SIZE 256
#define FLASH_SECTOR_SIZE 0x1000 /* 4KiB */
#define FLASH_SECTOR_TOTAL	((FLASH_SIZE * 1024) / FLASH_SECTOR_SIZE)
#define FLASH_SECTOR_LFS	(FLASH_SECTOR_TOTAL / 2) /* 8MiB */
