...
#define BOARD_SHELL_TASK_STACK_SIZE (configMINIMAL_STACK_SIZE + 2100)
...
/*! @brief The board flash address according to its FlexSPI connections */
#define BOARD_FLASH_START_ADDR (0x28000000u) /* FlexSPI1_AMBA_BASE_NS */

/*! @brief The board hyperram size */
#define BOARD_HYPERRAM_SIZE (0x00800000)

/*! @brief The board hyperram address according to its FlexSPI connections */
#define BOARD_HYPERRAM_START_ADDR (0x04000000u) /* FlexSPI2_AMBA_BASE_NS */

/* Re-use same free-running timer as GenAVB/TSN */
#define BOARD_TIMER_GET_COUNT()    GPT_GetCurrentTimerCount(GPT1)
