 ...
 *
 */
void BOARD_InitFlexSPIPins(void);             /* Function assigned for the Cortex-M33 */
...
/*!
 * @brief Configures pin routing and optionally pin electrical features for enabling hyperram.
 *
 */
