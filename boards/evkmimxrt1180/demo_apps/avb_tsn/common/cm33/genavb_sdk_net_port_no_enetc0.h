...
#ifndef _GENAVB_SDK_NET_PORT_NO_ENETC0_H_
#define _GENAVB_SDK_NET_PORT_NO_ENETC0_H_

/*! @brief NET configuration */
#define BOARD_NUM_PORTS          6
...
#define BOARD_NET_PORT1_DRV_BASE    (0) /* index of this port within bridge0 */
...
#define BOARD_NET_PORT2_DRV_BASE    (1)
...
#define BOARD_NET_PORT3_DRV_BASE    (2)
#define BOARD_NET_PORT3_PHY_INDEX   (2)
...
#define BOARD_NET_PORT4_DRV_BASE    (3)
...
#define BOARD_NET_PORT5_DRV_BASE    (4)
#define BOARD_NET_PORT5_PHY_INDEX   (-1)
...
#define BOARD_PHY2_ADDRESS            4
#define BOARD_PHY2_OPS                phyrtl8211f_ops
#define BOARD_PHY2_RX_LATENCY_100M    733
#define BOARD_PHY2_TX_LATENCY_100M    1297
#define BOARD_PHY2_RX_LATENCY_1G      530
#define BOARD_PHY2_TX_LATENCY_1G      202

#define BOARD_PHY3_MDIO_ID            0
#define BOARD_PHY3_ADDRESS            7
...
/*! @brief PORT Link configuration */
/* The configuration must be aligned with the MDIO/PHY configuration.*/

#define BOARD_NUM_LINK                1

#define BOARD_LINK0_ADDRESS           3                /* EP0 PHY address */
#define BOARD_LINK0_PORT              kNETC_SocLinkEp0

#endif /* _GENAVB_SDK_NET_PORT_NO_ENETC0_H_ */
