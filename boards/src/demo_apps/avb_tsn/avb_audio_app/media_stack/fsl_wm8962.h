...
/* Left Input Volume */
#define INPGAL_MUTE_BIT   (1<<7) // Left input PGA analogue mute

/* Right Input Volume */
#define IN_VU             (1<<8) // Input PGA volume update bit
#define INR_VOL           (0x2F) // Right input PGA volume, +12dB

/* Left Headphone Volume */
#define HPOUTL_VU_BIT     (1<<8) // Left Headphone output PGA Volume and Mute Update
#define HPOUTL_VOL        (0x7F) // Left Headphone output PGA Volume

/* Right Headphone Volume */
#define HPOUTR_VU_BIT     (1<<8) // Right Headphone output PGA Volume and Mute Update
#define HPOUTR_VOL        (0x7F) // Right Headphone output PGA Volume

/* Right input mixer Volume */
#define INPGAR_MIXINR_VOL (7<<3) // Right input PGA to Right input Boost Mixer Gain, +29dB
...
typedef struct _wm8962_handle
{
    ...
    int32_t (*send_data)(unsigned int instance, const void *data, size_t size);
    int32_t (*receive_data)(unsigned int instance, const void *reg, size_t reg_size, void *data, size_t size);
} wm8962_handle_t;
/*******************************************************************************
 * API
 ******************************************************************************/
