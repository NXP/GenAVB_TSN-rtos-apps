...
static void M1_StateInitFast(void)
{
    ...
    g_sM1Drive.sSpeed.bSpeedZCOn = FALSE;
    ...
    g_sM1Drive.sPosition.bFeedFrwdOn = FALSE;
...
static void M1_StateRunSpinSlow(void)
{
    ...
    if (g_sM1Drive.eControl == kControlMode_PositionFOC)
    {
        ...
        else
        {
            ...
            g_sM1Drive.sSpeed.fltSpeedCmd = MLIB_ConvSc_FLTsf(g_sM1Drive.sPosition.fltSpeedReq, M1_SPEED_CONV_SCALE);
