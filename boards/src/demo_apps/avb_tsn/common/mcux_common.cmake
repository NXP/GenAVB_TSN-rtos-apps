...
if(CONFIG_MCUX_PRJSEG_config.board.app_storage)
    ...
    mcux_add_source(
        ...
        SOURCES
        ${board_root}/${board}/demo_apps/avb_tsn/common/flexspi_hyper_flash_ops.c
        ${board_root}/${board}/demo_apps/avb_tsn/common/flexspi_ops.h
        ${board_root}/${board}/demo_apps/avb_tsn/common/lfs_hyperflash_nor.c
        DEVICE_IDS MIMXRT1052xxxxB
    )
endif()

include(${CMAKE_CURRENT_LIST_DIR}/iar/mcux_iar.cmake)
include(${SdkRootDirPath}/${board_root}/${board}/demo_apps/avb_tsn/common/mcux_linker.cmake OPTIONAL)
