...
#define BOARD_DEBUG_UART_BASEADDR LPUART_5
#define BOARD_DEBUG_UART_INSTANCE 5U
#define BOARD_UART_IRQ            LPUART_5_IRQn
#define BOARD_UART_IRQ_HANDLER    LPUART_5_IRQHandler
...
#define BOARD_USER_BUTTON_GPIO kSIUL2_PTD
#endif
#ifndef BOARD_USER_BUTTON_GPIO_PIN
#define BOARD_USER_BUTTON_GPIO_PIN (5U)
#endif
#define BOARD_SIUL2_BASE              SIUL2
#define BOARD_USER_BUTTON_IRQ         SIUL2_1_IRQn
#define BOARD_USER_BUTTON_IRQ_HANDLER SIUL2_1_IRQHandler
#define BOARD_USER_BUTTON_EIRQ        13U /* EIRQ13*/
