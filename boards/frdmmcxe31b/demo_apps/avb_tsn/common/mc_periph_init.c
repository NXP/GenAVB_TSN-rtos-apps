...
static void InitENC(void)
{
...
#if M1_POSPE_ENC_DIRECTION
    /* TRGMUX */
    TRGMUX_SetTriggerSource(TRGMUX, kTRGMUX_Emios0_1, kTRGMUX_TriggerInput0, kTRGMUX_SourceLcu0Lc0Out3); //5
    TRGMUX_SetTriggerSource(TRGMUX, kTRGMUX_Emios0_1, kTRGMUX_TriggerInput1, kTRGMUX_SourceLcu0Lc0Out2); //6
#else 
    /* TRGMUX */
    ...
    g_sM1Enc.sTo.fltThGain = M1_TO_THETA_GAIN;
