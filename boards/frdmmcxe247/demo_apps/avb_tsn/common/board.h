...
#define BOARD_SHELL_TASK_STACK_SIZE (configMINIMAL_STACK_SIZE + 600)

/* Re-use same free-running timer as GenAVB/TSN */
#define BOARD_TIMER_GET_COUNT()    FTM_GetCurrentTimerCount(FTM0)
#define BOARD_TIMER_MAX_VALUE    0xFFFF

#define BOARD_FTM_STATS   FTM4
